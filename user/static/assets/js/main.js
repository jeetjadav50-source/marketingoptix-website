(function ($) {
  ...
  // Newsletter AJAX Placeholder
  $(".footer-newsletter-btn").on("click", function (e) {
    e.preventDefault();
    const email = $(this).siblings("input").val();
    if (email && email.includes("@")) {
      $(this).text("Subscribed!").addClass("btn-success").prop("disabled", true);
      alert("Thank you for subscribing to MarketingOptix! We'll keep you posted.");
    } else {
